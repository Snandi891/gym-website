...
export default function Home() {
  ...
  const cardVariants = {
    ...
    visible: (index) => ({
      ...
      transition: {
        duration: 0.7,
        delay: index * 0.2, // dynamic delay per card
  ...
  return (
    <div className="min-h-screen bg-white text-gray-800 font-sans overflow-x-hidden">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
            {facilities.map((facility, index) => (
              <motion.div
                ...
                whileTap={{ scale: 0.98 }}
                onClick={handleTap}
                className="group rounded-3xl overflow-hidden shadow-2xl hover:shadow-3xl transition-all duration-700 bg-white border border-white/20 relative mobile-shine-effect"
              >
                ...
                <div className="h-72 overflow-hidden relative">
                  ...
                  {/* Premium icon badge */}
                  <motion.div
                    className="absolute top-5 right-5 w-16 h-16 bg-gradient-to-br from-amber-400 to-amber-600 backdrop-blur-md rounded-2xl flex items-center justify-center shadow-2xl z-20"
                  ...
                  {/* Hover title overlay */}
                  <motion.div
                    className="absolute bottom-0 left-0 w-full p-6 text-center z-20"
                    initial={{ opacity: 0, y: 20 }}
      ...
      <style jsx global>{`
        ...
        .mobile-shine-effect:hover:after,
        .mobile-shine-effect:active:after {
          left: 130%;
        }
